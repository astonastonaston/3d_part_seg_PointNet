...
n_pts = 2907
dataset = ShapeNetData(train = True, validation = False, num_points = n_pts, randomize_data = False)
# test_dataset = ShapeNetData(train = False, validation = False, num_points = n_pts, randomize_data = False)
# validation_dataset = ShapeNetData(train = True, validation = True, num_points = n_pts, randomize_data = False)
